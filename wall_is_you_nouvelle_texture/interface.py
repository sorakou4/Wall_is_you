...
# Dictionnaire qui associe un état de salle à un nom de fichier image
ETATS_TEXTURE = {
    # --- Couloirs ---
    ...
    (True, True, True, False): 'texture/haut-bas-droite.png',
    (False, True, True, True): 'texture/bas-gauche-droite.png',
    (True, False, True, False): 'texture/haut-bas-gauche.png',
    (True, True, False, False): 'texture/haut-gauche-droite.png',
    
    (True, True, True, True): 'texture/croix.png',
}
...
#--------------------------------------DEBUT DE LA NOUVELLE PARTIE AJOUTE---------------------------------------------------------------------------------------------
def ajouter_a_intention(case):
    ...
    if case_tuple in intention:
        try:
            index = intention.index(case_tuple)
...
def appliquer_intention():
    ...
    resultat = moteur.appliquer_tour_aventurier(donjon, aventurier, dragons, chemin, bonus)
...
def nouvelle_partie():
    ...
    """
    global donjon, aventurier, dragons, bonus, intention, nb_bonus
    
    donjon, aventurier, dragons, bonus = moteur.creer_donjon(
        nb_lignes, nb_colonnes, nb_dragons, nb_bonus, graine_donjon)
    ...
    while partie_en_cours:
        ...
        if type_ev == "Quitte":
            ...
            if touche == "Escape":
                ...
                # Appel de la fonction pour aplpiquer le tour et obtenir le statut
